...
function saveEvent() {
    ...
    if ($('#eventname').val() == '') {
        $('#eventname').next('span').text('Event Namw is required.');
        empty = true;
    }
    if ($('#eventdesc').val() == '') {
        $('#eventdesc').next('span').text('Event Description is required.');
        empty = true;
    }
    if ($('#eventdate').val() == '') {
        $('#eventdate').next('span').text('Event Date is required.');
        empty = true;
    }
