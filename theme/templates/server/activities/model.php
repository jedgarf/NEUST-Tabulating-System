			...
			if(count($querydata) > 0){
				...
				if ($actstartdate >= $curdate) {
					if ($actenddate > $actstartdate) {
						...
						return print json_encode(array('success' =>false,'status'=>500,'msg' =>'Error message: Invalid Date Range!'));
					}
				}else{
					return print json_encode(array('success' =>false,'status'=>500,'msg' =>'Error message: Cannot Start the date in the Past!'));
				}
			}
		}
	}
