...
class EventModel {
	...
	public static function read(){
		...
		if ($mysqli->connect_errno) {
			...
			session_start();
			$usid = $_SESSION['user'];
			$query1 ="SELECT * FROM events where eventid = (select eventid from users where userid = $usid) limit 1";
	...
	public static function detail($id){
		...
		if ($mysqli->connect_errno) {
			...
			$query2 = "SELECT * FROM events where eventid = (select eventid from users where userid = '$id') limit 1";
